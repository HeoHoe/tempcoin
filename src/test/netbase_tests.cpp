...
{
    BOOST_CHECK(CNetAddr("172.30.1.9").GetNetwork()                              == NET_UNROUTABLE);
...
{
    BOOST_CHECK(CNetAddr("172.30.1.9").IsIPv4());
    ...
    BOOST_CHECK(CNetAddr("172.30.1.9").IsLocal());
    BOOST_CHECK(CNetAddr("::1").IsLocal());
    BOOST_CHECK(CNetAddr("8.8.8.8").IsRoutable());
    BOOST_CHECK(CNetAddr("2001::1").IsRoutable());
    BOOST_CHECK(CNetAddr("172.30.1.9").IsValid());
}
...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("[www.bitcoin.org]:80", "www.bitcoin.org", 80));
    BOOST_CHECK(TestSplitHost("172.30.1.9", "172.30.1.9", -1));
    BOOST_CHECK(TestSplitHost("172.30.1.9:9333", "172.30.1.9", 9333));
    BOOST_CHECK(TestSplitHost("[172.30.1.9]", "172.30.1.9", -1));
    BOOST_CHECK(TestSplitHost("[172.30.1.9]:9333", "172.30.1.9", 9333));
    BOOST_CHECK(TestSplitHost("::ffff:172.30.1.9", "::ffff:172.30.1.9", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:172.30.1.9]:9333", "::ffff:172.30.1.9", 9333));
...
{
    BOOST_CHECK(TestParse("172.30.1.9", "172.30.1.9:65535"));
    BOOST_CHECK(TestParse("172.30.1.9:9333", "172.30.1.9:9333"));
    BOOST_CHECK(TestParse("::ffff:172.30.1.9", "172.30.1.9:65535"));
